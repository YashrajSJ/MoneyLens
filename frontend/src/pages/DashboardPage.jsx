...
export const DashboardPage = () => {
  return (
    <div className="space-y-8">
      <section className="flex flex-col justify-between gap-4 rounded-xl border border-slate-200 bg-white/90 p-5 shadow-sm backdrop-blur md:flex-row md:items-center">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
            Track balances, spending, budgets, receipts, recurring payments, and
            AI-powered money insights from one clean workspace.
          </p>
        </div>

        <div className="flex flex-wrap gap-2">
          <button className="inline-flex h-10 items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 text-sm font-medium text-slate-700 hover:bg-slate-50">
            <WalletCards size={17} />
            Add Account
          </button>
          <button className="inline-flex h-10 items-center gap-2 rounded-lg bg-slate-950 px-3 text-sm font-medium text-white hover:bg-slate-800">
            <Plus size={17} />
            Add Transaction
          </button>
        </div>
